...
class _CalculoCompletoState extends State<CalculoCompleto> {
  ...
  _validarConsulta() {
    if (_textFieldConsumoCarroGasolina.text == "") {
      _alerta_validar_campos(
          "Informe a média de consumo do seu veículo com gasolina!",
          "ATENÇÃO!");
    } else {
      if (_textFieldPrecoGasolina.text == "") {
        ...
        if (_textFieldConsumoCarroAlcool.text == "") {
          _alerta_validar_campos(
              "Informe a média de consumo do seu veículo com álcool!",
              "ATENÇÃO");
        } else {
          if (_textFieldPrecoAlcool.text == "") {
            ...
            if (_textFieldAbastecimento.text == "") {
              _alerta_validar_campos(
                  "Informe o valor para abastecer!", "ATENÇÃO");
            } else {
              _calculo();
  ...
  _calculo() {
    double calculoGasolina = (double.parse(_textFieldAbastecimento.text
            .replaceAll("R\$ ", "")
            .replaceAll(",", ".")) /
        double.parse(_textFieldPrecoGasolina.text
            .replaceAll("R\$ ", "")
            .replaceAll(",", ".")) *
        double.parse(_textFieldConsumoCarroGasolina.text
            .replaceAll("R\$ ", "")
            .replaceAll(",", ".")));

    double calculoAlcool = (double.parse(_textFieldAbastecimento.text
            .replaceAll("R\$ ", "")
            .replaceAll(",", ".")) /
        double.parse(_textFieldPrecoAlcool.text
            .replaceAll("R\$ ", "")
            .replaceAll(",", ".")) *
        double.parse(_textFieldConsumoCarroAlcool.text
            .replaceAll("R\$ ", "")
            .replaceAll(",", ".")));

    double calculoLitroGasolina = (double.parse(_textFieldAbastecimento.text
            .replaceAll("R\$ ", "")
            .replaceAll(",", ".")) /
        double.parse(_textFieldPrecoGasolina.text
            .replaceAll("R\$ ", "")
    ...
    double calculoLitroAlcool = (double.parse(_textFieldAbastecimento.text
            .replaceAll("R\$ ", "")
            .replaceAll(",", ".")) /
        double.parse(_textFieldPrecoAlcool.text
            .replaceAll("R\$ ", "")
    ...
    resultado.valorAbastecer = double.parse(_textFieldAbastecimento.text
        .replaceAll("R\$ ", "")
        .replaceAll(",", "."));
